...
HEADER = f'#{colored(" MacGyver [Help him out 1] ", "yellow")}#'
DASHES = "# ------------------------- #"
ADVICECLI = "Take all items if you wanna get out."
ADVICEPY = "Make a syringe."
POSSESSION = "In your possession -> "
NICE = "Nice job! Now, you can get out."
WINCLI = colored("Congats, You WIN", "green")
WINPY = "Congrats, you win! Free to get out"
LOSECLI = colored("You lose, you die\nGAME OVER", "red")
LOSEPY = "You lose! you die... GAME OVER !!!"
